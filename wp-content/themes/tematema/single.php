...
<div class="container-fluid vijesti-maindiv">
    ...
    <div class="row">
        <div class="col-lg-8 col-sm-12 vijesti-left">
            ...
            $istaknutaSlika;
            ?>
            <p class="h4" style="padding-top:0.5em;">Pročitajte više.</p>
            <hr>
            <small style="color:#0174b2;">Dana <?php echo $post->post_date ?></small>
            <div class="row">
                <div class="col-sm-5">
                ...
                <div class="col-sm-7" style="padding-right:1em;">
                    <p class="h4" style="padding-top:0.5em;"><?php echo $post->post_title ?></p>
                    <p class="vijesti-text"><?php echo $post->post_content?></p>
                </div>
            </div>
        </div>
            ...
            <div class="list-group">
                ...
                foreach ($recent_posts as $post) : ?>
                    <a href="<?php echo $post['guid']?>" style="margin-top:15px;" class="list-group-item list-group-item-action flex-column align-items-start active">
                        ...
                        <p class="mb-1"><?php echo skrati_tekst_tekst($post['post_content'], 120) ?></p>
